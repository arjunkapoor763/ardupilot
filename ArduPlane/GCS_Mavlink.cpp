...
void GCS_MAVLINK_Plane::handleMessage(mavlink_message_t* msg)
{
	...
	{
		plane.rfm.handle_pa_geofence_points(chan,msg,fence);
...
//			send_text(MAV_SEVERITY_WARNING,"Fencing must be disabled");
//		}
//		else if (packet.total_count != plane.g.fence_total)
//		{
//			send_text(MAV_SEVERITY_WARNING,"Bad fence point");
//		}
//		else if (!check_latlng(packet.Latitude,packet.Longitude))
//		{
//			send_text(MAV_SEVERITY_WARNING,"Invalid fence point, lat or lng too large");
//		}
//		else
//		{
//			plane.set_fence_point_with_index(Vector2l(packet.Latitude*1.0e7f, packet.Longitude*1.0e7f), packet.waypoint_id);
//			_fence_count=packet.total_count+1;
//		}
		break;
	}
